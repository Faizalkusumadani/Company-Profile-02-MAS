            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-15 items-center">
              <div className="order-1 lg:order-1 ">
                <div className=" py-6 space-y-6">
                  <h2 className="text-4xl md:text-5xl font-bold text-mas-red text-center">
                    Core Values
                  </h2>
              ...
              <div className="order-2 lg:order-2 space-y-6">
                {coreValues.map((value, index) => (
                  ...
                  >
                    {/* <!-- Letter --> */}
                    <div
                      className={`text-5xl md:text-6xl font-bold ${value.color} leading-none p-7 border-y-2 border-mas-red rounded-full`}
                    >
                      {value.letter}
                    </div>
