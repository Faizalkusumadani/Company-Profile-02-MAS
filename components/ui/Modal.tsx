  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button
          variant="outline"
          className="rounded-full border-mas-red text-mas-red hover:bg-mas-red hover:text-white transition-colors duration-200 text-sm font-medium px-5 py-2"
        >
          {t("CTA")}
        </Button>
      </DialogTrigger>
        ...
        <div className="flex flex-col md:flex-row h-full max-h-[92dvh]">
          ...
          <div className="flex flex-col items-center bg-gray-100 md:w-[38%] lg:w-[36%] shrink-0 p-6 md:p-10 border-b md:border-b-0 md:border-r border-gray-200">
            ...
            <div className="text-center w-full">
              ...
              <p className="mt-1 text-mas-red font-semibold text-sm md:text-base">
                {position}
              </p>
            </div>
          </div>
