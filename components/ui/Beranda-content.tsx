...
import Slides from "../../app/tools/slides";
import features from "../../app/tools/features";
import testimoniData from "../../app/tools/testimoniData";
import Brands from "../../app/tools/brands";
import faqData from "../../app/tools/faq";
    ...
    <div className="w-full py-20">
          ...
          >
            ...
            <h2 className="mt-4 text-3xl sm:text-4xl md:text-5xl font-extrabold text-mas-dark leading-tight max-w-3xl tracking-tight">
              ...
              <span className="text-mas-red">
                {" "}
                {tfeature("title_features_01")}
              </span>
              <span> {tfeature("title_features_02")}</span>
            </h2>
          </m.div>
                ...
                >
                  <div className="flex flex-col h-full justify-start">
                    ...
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <h3 className="text-lg font-bold text-mas-dark leading-snug group-hover:text-mas-red transition-colors duration-200">
              ...
              {locationCards.map(({ key, icon: Icon, nameKey, descKey }) => (
                ...
                >
                  ...
                  <div className="relative z-10 flex items-start gap-5">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-mas-dark mb-2">
                        {tproduct(nameKey)}
                      </h3>
      ...
      <div className="px-4 py-15 sm:py-18 lg:py-20">
        <FaqAccordion
          data={faqAllData}
          title={(() => {
            const [firstWord, ...rest] = tfaq("title_faq").split(" ");
            return (
              <>
                <span className="text-mas-dark">{firstWord}</span>{" "}
                <span className="text-mas-red">{rest.join(" ")}</span>
              </>
            );
          })()}
